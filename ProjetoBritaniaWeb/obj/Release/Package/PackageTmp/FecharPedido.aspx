<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="FecharPedido.aspx.cs" Inherits="ProjetoBritaniaWeb.FecharPedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
      ...
      <i class="glyphicon glyphicon-shopping-cart"></i>Fechar Pedido<br />
        ...
        <div class="row">
            <div class="col-md-3">
                <span style="font-size:16px;" class="glyphicon glyphicon-euro"></span> <asp:Label ID="Label10" runat="server" Text="Valor Total Entregue"></asp:Label> 
                <br />
                <h5>
                    <strong>R$ </strong> 
        <asp:Label ID="lblvalorentregue" runat="server" style="font-weight: 700"></asp:Label>
                    </h5>
            </div>
            <div class="col-md-3">
                <span style="font-size:16px;" class="glyphicon glyphicon-euro"></span> <asp:Label ID="Label12" runat="server" Text="Valor sem Desconto"></asp:Label> 
        
                <br />

                <h5>
                    <strong>R$ </strong> 
        <asp:Label ID="lblvalorsdesconto" runat="server" style="font-weight: 700"></asp:Label>
        </h5>
            </div>
               <div class="col-md-3">
                <span style="font-size:16px;" class="glyphicon glyphicon-euro"></span> <asp:Label ID="Label14" runat="server" Text="30% Comissão"></asp:Label> 
        
                <br />
                   <h5>
                    <strong>R$ </strong> 
        <asp:Label ID="lblcomissao" runat="server" style="font-weight: 700"></asp:Label>
        </h5>
            </div>
            <div class="col-md-3">
                <span style="font-size:16px;" class="glyphicon glyphicon-euro"></span> <asp:Label ID="Label16" runat="server" Text="Valor a Pagar"></asp:Label> 
        
                <br />
                <h5>
                    <strong>R$</strong> 
        <asp:Label ID="lblvalorpagar" runat="server" style="font-weight: 700"></asp:Label>
                </h5>
        ...
        <asp:TextBox ID="txtquantidade" runat="server" CssClass="form-control"  AutoPostBack="True" OnTextChanged="txtquantidade_TextChanged"></asp:TextBox>
        </div>
             <div class="col-md-4">
